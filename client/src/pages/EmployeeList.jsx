...
export default function EmployeeList({ user }) {
  ...
  return (
    <div className="page-wrapper page-employees">
      <div className="page-header">
        <div className="container">
          <div>
            <h1>Справочник сотрудников</h1>
            <div className="page-subtitle">Управление кадрами и персональными данными</div>
          </div>
          <button className="btn" onClick={() => setShowForm(!showForm)}>
            {showForm ? 'Свернуть форму' : 'Добавить сотрудника'}
          </button>
        </div>
      </div>
      <div className="container">
